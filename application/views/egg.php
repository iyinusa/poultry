    <div class="rightside">
        ...
        <div class="content">
            <div class="row">
                <div class="col-sm-4">
                    <?php echo form_open_multipart('eggs'); ?>
                        <div class="box">
                            <div class="box-title">
                            ...
                            <div class="box-body" style="overflow:auto;">
                                ...
                                <div class="col-lg-12">
                                	<div class="form-group">
                                        <input type="hidden" name="egg_id" value="<?php if(!empty($e_id)){echo $e_id;} ?>" />
                                        ...
                                        <input type="text" name="qty" placeholder="Eggs Quantity" class="form-control" value="<?php if(!empty($e_qty)){echo $e_qty;} ?>" required="required" />
                                    </div>
                                </div>
                            </div>
									...
									foreach($allup as $up){
										...
										$dir_list .= '
											<tr>
												...
												<td>'.$up->qty.'</td>
												<td>
													<a href="'.base_url().'eggs?edit='.$up->id.'" class="btn btn-primary btn"><i class="fa fa-pencil"></i> Edit</a>
													<a href="'.base_url().'eggs?del='.$up->id.'" class="btn btn-danger btn"><i class="fa fa-times"></i> Delete</a>
												</td>
											</tr>
										';	
									}
